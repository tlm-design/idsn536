...
char serverAddress[] = "shrouded-journey-28713-8925aeec451e.herokuapp.com";   // server address
int port = 80;//3000;
...
void loop() {
  ...
  while (client.connected()) {
    ...
    if (messageSize > 0) {
      ...
      counter = 0;
      lastIndex = 0;
      if(socketdata[0]=="ON"){ ringChime(socketdata[2]);}
        else{stopChime();}
    }
  }
...
void ringChime( String intensity){
